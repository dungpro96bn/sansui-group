...
//content pages
Route::get('/beginners', [ContentController::class, 'show'])->defaults('path', 'beginners')->name('beginners');
Route::get('/jobs', [ContentController::class, 'show'])->defaults('path', 'jobs')->name('jobs');
Route::get('/point', [ContentController::class, 'show'])->defaults('path', 'point')->name('point');
