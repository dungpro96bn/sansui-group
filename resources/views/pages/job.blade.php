...
@section('content')
                            ...
                            <div class="horizontalTabBody">
                                <div id="jobone">
                                    ...
                                    <aside class="applyBtns">
                                        ...
                                        <a class="goApply telDialog" href="#" data-modaltarget="teldal" onclick="ga('send','event','tel-tap-{{$fEntJobDetail->corpCd}}-pc','click','tel-entry1');">
                                    ...
                                    <aside class="applyBtns">
                                        ...
                                        @if($applyTelNumber && mb_strlen($applyTelNumber) > 0)
                                        <a class="goApply telDialog" href="#" data-modaltarget="teldal" onclick="ga('send','event','tel-tap-{{$fEntJobDetail->corpCd}}-pc','click','tel-entry2');">
                                            @lang('textlist.telApply')
                                            <i class="fas fa-chevron-right"></i>
                                        </a>
                                        @endif
                            ...
                            <div class="horizontalTabBody">
                                <div id="jobone">
                                    ...
                                    <aside class="applyTelBtns">
                                        <a class="goApply" href="tel: {{$applyTelNumber}}" onclick="ga(\'send\',\'event\',\'tel-tap-{{$fEntJobDetail->corpCd}}-sp\',\'click\',\'tel-entry1\');">@lang('textlist.telApply')<i class="fas fa-chevron-right"></i></a>
                                    </aside>
                                    @endif
                                    <aside class="applyBtns">
    ...
    <div id="jobDetailSearchBox">
        <x-searchBox :arrayFEntJob="$arrayFEntJob??''" />
    </div>
@endsection
